...
import { 
  ...
  Briefcase, CheckCircle, AlertCircle, Bell, Key, X, Trash2
} from 'lucide-react';
...
const AgentDashboard = () => {
  ...
  const fetchNotifications = async (userId) => {
    ...
    try {
      ...
      if (data.success) {
        // Filtrer pour s'assurer que seules les notifications de l'utilisateur sont affichées
        const userNotifications = data.notifications.filter(n => n.user_id === userId);
                        ...
                        >
                          ...
                          <div className="notification-content">
                            ...
                            <div className="notification-message">
                              {notif.reason?.substring(0, 50) || 'Changement de mot de passe'}...
                            </div>
      ...
      >
        <div className="stat-card">
          ...
          <div>
            ...
            <span className="stat-value">{stats.missions}</span>
          </div>
        </div>
        <div className="stat-card">
          <CheckCircle size={24} />
              ...
              {notifications.slice(0, 3).map(notif => (
                ...
                >
                  ...
                  <div className="recent-content">
                    ...
                    <div className="recent-reason">{notif.reason || 'Changement de mot de passe'}</div>
